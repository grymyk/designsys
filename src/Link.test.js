...
/**
 * A straightforward link wrapper that renders an <a>
 * with the passed props.
 * What we are testing here is that the Link component passes
 * the right props to the wrapper and itself.
 */
